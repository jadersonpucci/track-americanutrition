...
const ICONES = ['ti-shopping-cart', 'ti-tool', 'ti-trending-up', 'ti-percentage', 'ti-flask', 'ti-package', 'ti-truck', 'ti-credit-card', 'ti-users', 'ti-user-star', 'ti-home', 'ti-bolt', 'ti-droplet', 'ti-wifi', 'ti-speakerphone', 'ti-ad', 'ti-printer', 'ti-video', 'ti-plane', 'ti-building-bank', 'ti-alert-triangle', 'ti-heart', 'ti-device-laptop', 'ti-cash-banknote', 'ti-pie-chart', 'ti-apps', 'ti-calculator', 'ti-microscope', 'ti-scale', 'ti-gift', 'ti-coins', 'ti-hammer', 'ti-tools', 'ti-paperclip', 'ti-file-percent', 'ti-building', 'ti-receipt-refund', 'ti-users-group', 'ti-arrows-exchange', 'ti-tag', 'ti-crane', 'ti-building-warehouse', 'ti-cash-off', 'ti-arrow-down-circle', 'ti-arrow-up-circle', 'ti-beach', 'ti-door-exit', 'ti-hand-coin', 'ti-discount', 'ti-dots', 'ti-car', 'ti-phone', 'ti-book', 'ti-school', 'ti-shield', 'ti-briefcase', 'ti-world', 'ti-star'];
